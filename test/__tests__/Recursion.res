...
module type Rec = {
  @decco type rec basic = Basic(basic) | End
  @decco type rec nested = Nested(option<nested>)
  @decco type rec tuple = Tuple((int, tuple)) | End
  @decco type rec record = {r: option<record>}
}
...
module type NonRec = {
  @decco type nonRecVariant = Var(nonRecVariant)
  @decco type nonRecRecord = {num: nonRecRecord}
}
